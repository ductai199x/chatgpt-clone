...
export class OpenAIService extends ApiService {
  ...
  async chatCompletion(messages, modelId = 'gpt-4.1', options = {}, enabledTools = []) {
    try {
...
export class AnthropicService extends ApiService {
  ...
  async chatCompletion(messages, modelId = 'claude-3-7-sonnet-20250219', options = {}, enabledTools = []) {
    try {
